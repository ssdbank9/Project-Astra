...
updated-at: 2026-09-25T14:35:36Z
updated-by: Claude
claimed-by: vm-26940
...
- [x] WIP limits: schema v20 wip_limits with migration tests; only an owner sets or clears a limit per board column per project (audited as wip_limit_changed in project history); a board move or bulk status change that would exceed a limit is refused with a clear reason, and an owner may override after a confirm (audited as wip_limit_override)
