...
- **2026-09-24 17:16 · Claude** — Follow-up 2026-09-24: the review gap 'cap blocked notices per actor per 10 minutes' is done in KBWY86 (5 per recipient and actor per 10 min, pooled across blocked kinds). The same-key 10-minute dedupe in _owner_change_blocked was removed there, so every blocked owner change is now audited.
