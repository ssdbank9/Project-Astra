...
updated-at: 2026-09-25T14:11:39Z
updated-by: Claude
claimed-by: vm-32647
...
- [x] Server: task_locks table (schema v19, migration with tests); acquire, renew, release and owner force-unlock (audited as task_lock_forced, holder notified); every task write refuses with 409 naming the holder and expiry while someone else holds an unexpired lease; leases expire after 60 s
